  ...
  >
    ...
    <template #default>
      <div class="flow-container">
        <el-steps class="mb-4" :space="200" :active="flowState.step" simple>
          <el-step title="留校申请" :icon="Edit" />
          <el-step title="申请审批" :icon="Picture" />
          <el-step title="住宿安排" :icon="Picture" />
          <el-step title="完成" :icon="Picture" />
        </el-steps>
      </div>
      <div class="content" v-show="flowState.step == 0">
        <div class="apply-form">
          <div class="apply-form-title">留校申请表</div>
          <div class="apply-form-notic">
            <p class="title">申请须知：</p>
            <p class="content">
              1.留校学生需遵守学校疫情防控期间的相关规定，如非必要不出校，离校需报备等
            </p>
            <p class="content">
              2.学生可能需要签订安全承诺书，确保个人安全
            </p>
          </div>
          <el-form
            ref="baseFormRef"
          ...
          >
            <div class="form-table">
              ...
              <div class="row row4">
                <div class="item label fw600">申请留校类别</div>
                <div class="item">
              ...
              <div class="row row11">
                <div class="item label fw600">留校时间</div>
                <div class="item">
                  <el-form-item prop="card">
                    <template v-if="status != 'view'">
                      <el-date-picker
      ...
      <div class="content" v-show="flowState.step == 3">
        <div
          style="
            display: flex;
            align-items: center;
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="nextChange" v-if="flowState.step < 3 && status != 'add'"
          >下一步</el-button
        >
      </div>
    </template>
...
const rules = reactive({
  ...
  gender: [{ required: true, message: "请选择留校类别", trigger: "blur" }],
